...
from apps.compras.setting_apps import COMPRAS_SETTINGS_APPS
...
]+CATALOGOS_SETTINGS_APPS +SEGURIDAD_SETTINGS_APPS +COMPRAS_SETTINGS_APPS +VENTAS_SETTINGS_APPS +LABORATORIO_SETTINGS_APPS
